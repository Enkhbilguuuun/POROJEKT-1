      ...
      <>
        <div className="ContainerOther">
          ...
          <div className="productPost">
            <h1>10 Secrets for making ur teacher convinced</h1>
            <div className="userInfo">
              <img src={require("../images/Avatar (4).png")} alt="userImg" />
              <span>Enkhbilguun Bata</span>
              <br />
              <span>8th November,2022</span>
            </div>
            ...
            <div className="userInfoBottom">
              ...
              <div className="madeBy">
                <span>Writen By</span>
                <p>Enkhbilguun Bata</p>
                <div>Master Convincer</div>
              </div>
            </div>
            <br />
            <span className="neva">Join the conversation</span>
            <div className="commit">
              <img src={require("../images/Avatar (4).png")} alt="avatarUser" />
              <textarea
